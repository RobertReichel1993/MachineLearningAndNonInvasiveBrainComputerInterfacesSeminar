...
%Defining trigger shift (First row is trigger allignment, second row is end of instruction allignment)
shift = [3.6 3.6 3.7;
        3.1 3.1 3.2];
%Shifting triggers by delay
triggers_AC21 = double(triggers_AC21) + double(round(shift(1, 1) * fs));
triggers_AC22 = double(triggers_AC22) + double(round(shift(1, 2) * fs));
triggers_AC23 = double(triggers_AC23) + double(round(shift(1, 3) * fs));
%%
...
[IdcsOfTaintedTrials_AC22, ~] = PerformOutlierRejection(window_mrcp(1) * fs, ...
    window_mrcp(2) * fs - 1, data_AC22_erds, triggers_AC22, fs);
%Now cutting out all bad trials
triggers_AC22(IdcsOfTaintedTrials_AC22) = [];
trials_AC22(IdcsOfTaintedTrials_AC22)  = [];
%Artifact rejection for Patient AC 23
[IdcsOfTaintedTrials_AC23, ~] = PerformOutlierRejection(window_mrcp(1) * fs, ...
    window_mrcp(2) * fs - 1, data_AC23_erds, triggers_AC23, fs);
%Now cutting out all bad trials
triggers_AC23(IdcsOfTaintedTrials_AC23) = [];
trials_AC23(IdcsOfTaintedTrials_AC23)  = [];
%%
%Analysis of Data
...
plot_Analysis(data_AC22_erds, triggers_AC22, trials_AC22, window_mrcp, ...
     window_erds, ref_window, channels, eloc, fs, strcat('AC22_', add_info));
%Patient AC23
...
%%
%Analysing data in frequency spectrum like NIV BCI KU 02
accs_AC21 = zeros(5, 1);
bands_AC21 = zeros(5, 4);
accs_AC22 = zeros(5, 1);
bands_AC22 = zeros(5, 4);
accs_AC23_1_2 = zeros(5, 1);
bands_AC23_1_2 = zeros(5, 4);
accs_AC23_1_3 = zeros(5, 1);
bands_AC23_1_3 = zeros(5, 4);
accs_AC23_2_3 = zeros(5, 1);
bands_AC23_2_3 = zeros(5, 4);

for num_bands = 2 : 2 : 16
    [accuracy_AC21, bands_tmp, csps_tmp] = csp_analysis(data_AC21_erds, ...
        triggers_AC21, [60 61], trials_AC21, window_erds, fs, num_bands, 10, ...
        [0 40], 10, 5);
    accs_AC21(num_bands/2) = accuracy_AC21;
    bands_AC21(num_bands/2, :) = bands_tmp;
    
    [accuracy_AC22, bands_tmp, csps_tmp] = csp_analysis(data_AC22_erds, ...
        triggers_AC22, [60 61], trials_AC22, window_erds, fs, num_bands, 10, ...
        [0 40], 10, 5);
    accs_AC22(num_bands/2) = accuracy_AC22;
    bands_AC22(num_bands/2, :) = bands_tmp;
    
    [accuracy_AC23_1_2, bands_tmp, csps_tmp] = csp_analysis(data_AC23_erds, ...
        triggers_AC23, [60 61], trials_AC23, window_erds, fs, num_bands, 10, ...
        [0 40], 10, 5);
    accs_AC23_1_2(num_bands/2) = accuracy_AC23_1_2;
    bands_AC23_1_2(num_bands/2, :) = bands_tmp;

    [accuracy_AC23_1_3, bands_tmp, csps_tmp] = csp_analysis(data_AC23_erds, ...
        triggers_AC23, [60 62], trials_AC23, window_erds, fs, num_bands, 10, ...
        [0 40], 10, 5);
    accs_AC23_1_3(num_bands/2) = accuracy_AC23_1_3;
    bands_AC23_1_3(num_bands/2, :) = bands_tmp;
    
    [accuracy_AC23_2_3, bands_tmp, csps_tmp] = csp_analysis(data_AC23_erds, ...
        triggers_AC23, [61 62], trials_AC23, window_erds, fs, num_bands, 10, ...
        [0 40], 10, 5);
    accs_AC23_2_3(num_bands/2) = accuracy_AC23_2_3;
    bands_AC23_2_3(num_bands/2, :) = bands_tmp;
end

save(strcat('..\Data\Results Usual CSP stuff', add_info)', 'accs_AC21', ...
    'bands_AC21', ...
    'accs_AC22', 'bands_AC22', ...
    'accs_AC23_1_2', 'bands_AC23_1_2', ...
    'accs_AC23_1_3', 'bands_AC23_1_3', ...
    'accs_AC23_2_3', 'bands_AC23_2_3');
%%
%%{
%Patient AC21
...
save(strcat('..\Data\Results Patient AC21', add_info), 'acc_AC21_freq_paper', 'acc_AC21_freq_csp_all', ...
    'acc_AC21_freq_csp_bins', 'acc_AC21_time_paper', ...
    'acc_AC21_time_robert', 'acc_AC21_time_valeria');

save(strcat('..\Data\Features Patient AC21', add_info)', 'features_class_1_AC21_avrfreq', ...
...
[features_class_1_AC22_m1, features_class_2_AC22_m1] = get_features_significantPoints(data_AC22_mrcp, ...
    ...
    strcat('Significance window sanity check Robert Method, Patient AC 22', add_info));
%Calculating features for method 2 (Valeria's Method)
[features_class_1_AC22_m2, features_class_2_AC22_m2] = get_features_significanceWindow(data_AC22_mrcp, ...
    ...
    strcat('Significance window sanity check Valerias Method, Patient AC 22', add_info));
%Calculating features for method 3 (As in paper Method)
[features_class_1_AC22_paper, features_class_2_AC22_paper, ~] = get_features_paper(data_AC22_mrcp, ...
    ...
    strcat('Significance window sanity check Paper Method, Patient AC 22', add_info));
...
save(strcat('..\Data\Results Patient AC22', add_info), 'acc_AC22_freq_paper', 'acc_AC22_freq_csp_all', ...
    'acc_AC22_freq_csp_bins', 'acc_AC22_time_paper', 'acc_AC22_time_robert', ...
    'acc_AC22_time_valeria');

save(strcat('..\Data\Features Patient AC22', add_info), 'features_class_1_AC22_avrfreq', ...
...
%Calculate frequency features with CSP for class 60 and 61
[features_class_1_AC23_csp, features_class_2_AC23_csp] = analyse_csp_features(data_AC23_erds, ...
    ...
    5, strcat('Accuracy plot CSP filtered data Patient AC23, classes 60 and 61', add_info));
%Transforming csp features two different ways
...
[features_class_1_AC23_csp, features_class_3_AC23_csp] = analyse_csp_features(data_AC23_erds, ...
    ...
    5, strcat('Accuracy plot CSP filtered data Patient AC23, classes 60 and 62', add_info));
%Transforming csp features two different ways
...
[features_class_2_AC23_csp, features_class_3_AC23_csp] = analyse_csp_features(data_AC23_erds, ...
    ...
    5, strcat('Accuracy plot CSP filtered data Patient AC23, classes 61 and 62', add_info));
%Transforming csp features two different ways
...
[features_class_1_AC23_m1_12, features_class_2_AC23_m1_12] = get_features_significantPoints(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Robert Method, Patient AC 23, classes 60 and 61', add_info));
%Classification and kfolding for time domain features, Method Robert
...
[features_class_1_AC23_m1_13, features_class_3_AC23_m1_13] = get_features_significantPoints(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Robert Method, Patient AC 23, classes 60 and 62', add_info));
%Classification and kfolding for time domain features, Method Robert
...
[features_class_2_AC23_m1_23, features_class_3_AC23_m1_23] = get_features_significantPoints(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Robert Method, Patient AC 23, classes 61 and 62', add_info));
%Classification and kfolding for time domain features, Method Robert
...
[features_class_1_AC23_m2_12, features_class_2_AC23_m2_12] = get_features_significanceWindow(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Valerias Method, Patient AC 23, classes 60 and 61', add_info));
%Classification and kfolding for time domain features, Method Valeria
...
[features_class_1_AC23_m2_13, features_class_3_AC23_m2_13] = get_features_significanceWindow(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Valerias Method, Patient AC 23, classes 60 and 62', add_info));
%Classification and kfolding for time domain features, Method Valeria
...
[features_class_2_AC23_m2_23, features_class_3_AC23_m2_23] = get_features_significanceWindow(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Valerias Method, Patient AC 23, classes 62 and 62', add_info));
%Classification and kfolding for time domain features, Method Valeria
...
[features_class_1_AC23_paper_12, features_class_2_AC23_paper_12, ~] = get_features_paper(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Paper Method, Patient AC 23, classes 60 and 61', add_info));
%Classification and kfolding for frequency features from paper
...
[features_class_1_AC23_paper_13, features_class_3_AC23_paper_13, ~] = get_features_paper(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Paper Method, Patient AC 23, classes 60 and 62', add_info));
%Classification and kfolding for frequency features from paper
...
[features_class_2_AC23_paper_23, features_class_3_AC23_paper_23, ~] = get_features_paper(data_AC23_mrcp, ...
    ...
    strcat('Significance window sanity check Paper Method, Patient AC 23, classes 61 and 62', add_info));
%Classification and kfolding for frequency features from paper
...
save(strcat('..\Data\Results Patient AC23', add_info), ...
...
save(strcat('..\Data\Features Patient AC23', add_info), 'features_class_1_AC23_avrfreq', ...
