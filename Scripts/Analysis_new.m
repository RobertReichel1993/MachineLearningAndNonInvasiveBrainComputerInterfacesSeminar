...
[acc_AC21_robert] = permute_and_kfold(cat(1, features_class_1_AC21, features_class_1_AC21_m1), ...
...
[acc_AC21_valeria] = permute_and_kfold(cat(1, features_class_1_AC21, features_class_1_AC21_m2), ...
...
[acc_AC21_paper] = permute_and_kfold(cat(1, features_class_1_AC21, features_class_1_paper), ...
    cat(1, features_class_2_AC21, features_class_2_paper), rep_fac, kfold_fac);

save('Results Patient AC21', 'acc_AC21_robert', 'acc_AC21_valeria', 'acc_AC21_paper');
%%}
%%
%Patient AC22
%%{
...
%Classification and kfolding for method 1 (my "interesting" idea)
[acc_AC22_robert] = permute_and_kfold(cat(1, features_class_1_AC22, features_class_1_AC22_m1), ...
...
%Classification and kfolding for method 2 (Valeria's Method)
[acc_AC22_valeria] = permute_and_kfold(cat(1, features_class_1_AC22, features_class_1_AC22_m2), ...
...
%Classification and kfolding for method 3 (From paper)
[acc_AC22_paper] = permute_and_kfold(cat(1, features_class_1_AC22, features_class_1_paper), ...
    cat(1, features_class_2_AC22, features_class_2_paper), rep_fac, kfold_fac);

save('Results Patient AC22', 'acc_AC22_robert', 'acc_AC22_valeria', 'acc_AC22_paper');
%%}
%%
%Patient AC23
%%{
...
%Classification and kfolding for method 1 (my "interesting" idea)
[acc_AC23_robert] = permute_and_kfold(cat(1, features_class_1_AC23, features_class_1_AC23_m1), ...
...
%Classification and kfolding for method 2  (Valeria's Method)
[acc_AC23_valeria] = permute_and_kfold(cat(1, features_class_1_AC23, features_class_1_AC23_m2), ...
...
%Classification and kfolding for method 3 (From paper)
[acc_AC23_paper] = permute_and_kfold(cat(1, features_class_1_AC23, features_class_1_paper), ...
    cat(1, features_class_2_AC23, features_class_2_paper), rep_fac, kfold_fac);

save('Results Patient AC23', 'acc_AC23_robert', 'acc_AC23_valeria', 'acc_AC23_paper');
%%}