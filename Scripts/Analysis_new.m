...
[acc_AC21_time_paper] = permute_and_kfold(features_class_1_paper, ...
    features_class_2_paper, rep_fac, kfold_fac);
...
save('..\Data\Results Patient AC21', 'acc_AC21_freq_paper', 'acc_AC21_freq_csp_all', ...
    'acc_AC21_freq_csp_bins', 'acc_AC21_time_paper', 'acc_AC21_time_robert', 'acc_AC21_time_valeria');
%}
%%
%Patient AC22
%{
...
%Classification and kfolding for time domain features, Method Paper
[acc_AC22_time_paper] = permute_and_kfold(features_class_1_paper, ...
    features_class_2_paper, rep_fac, kfold_fac);
%Classification and kfolding for time domain features, Method Robert
...
save('..\Data\Results Patient AC22', 'acc_AC22_freq_paper', 'acc_AC22_freq_csp_all', ...
    'acc_AC22_freq_csp_bins', 'acc_AC22_time_paper', 'acc_AC22_time_robert', 'acc_AC22_time_valeria');
%}
%%
%Patient AC23
%%{
...
%Transforming csp features two different ways
features_class_1_AC23_csp_all = sum(features_class_1_AC23_csp);
features_class_2_AC23_csp_all = sum(features_class_2_AC23_csp);
%Preallocating storage space
features_class_1_AC23_csp_bins = zeros(size(freqs ,1), size(features_class_1_AC23_csp_all, 2), ...
    size(features_class_1_AC23_csp_all, 3));
features_class_2_AC23_csp_bins = zeros(size(freqs ,1), size(features_class_2_AC23_csp_all, 2), ...
    size(features_class_2_AC23_csp_all, 3));
%Averaging over frequency bins
for bin = 1 : size(freqs , 1)
    features_class_1_AC23_csp_bins(bin, :, :) = mean(...
        features_class_1_AC23_csp(freqs(bin, 1) : features_class_1_AC23_csp(bin, 2), :, :), 1);
    features_class_2_AC23_csp_bins(bin, :, :) = mean(...
...
[acc_AC23_freq_csp_class_1_2_all] = permute_and_kfold(features_class_1_AC23_csp_all, ...
    features_class_2_AC23_csp_all, rep_fac, kfold_fac);
%Classification with CSP features for average across frequency bins
[acc_AC23_freq_csp_class_1_2_bins] = permute_and_kfold(features_class_1_AC23_csp_bins, ...
    features_class_2_AC23_csp_bins, rep_fac, kfold_fac);
...
%Transforming csp features two different ways
features_class_1_AC23_csp_all = sum(features_class_1_AC23_csp);
features_class_3_AC23_csp_all = sum(features_class_3_AC23_csp);
%Preallocating storage space
features_class_1_AC23_csp_bins = zeros(size(freqs ,1), size(features_class_1_AC23_csp_all, 2), ...
    size(features_class_1_AC23_csp_all, 3));
features_class_3_AC23_csp_bins = zeros(size(freqs ,1), size(features_class_3_AC23_csp_all, 2), ...
    size(features_class_3_AC23_csp_all, 3));
%Averaging over frequency bins
for bin = 1 : size(freqs , 1)
    features_class_1_AC23_csp_bins(bin, :, :) = mean(...
        features_class_1_AC23_csp(freqs(bin, 1) : features_class_1_AC23_csp(bin, 2), :, :), 1);
    features_class_3_AC23_csp_bins(bin, :, :) = mean(...
        features_class_3_AC23_csp(freqs(bin, 1) : features_class_3_AC23_csp(bin, 2), :, :), 1);
end
%Classification with CSP features for average across all freqencies
[acc_AC23_freq_csp_class_1_3_all] = permute_and_kfold(features_class_1_AC23_csp_all, ...
    features_class_3_AC23_csp_all, rep_fac, kfold_fac);
%Classification with CSP features for average across frequency bins
[acc_AC23_freq_csp_class_1_3_bins] = permute_and_kfold(features_class_1_AC23_csp_bins, ...
    features_class_3_AC23_csp_bins, rep_fac, kfold_fac);
...
%Classification with CSP features for average across all freqencies
[acc_AC23_freq_csp_class_2_3_all] = permute_and_kfold(features_class_2_AC23_csp_all, ...
    features_class_3_AC23_csp_all, rep_fac, kfold_fac);
%Classification with CSP features for average across frequency bins
[acc_AC23_freq_csp_class_2_3_bins] = permute_and_kfold(features_class_2_AC23_csp_bins, ...
    features_class_3_AC23_csp_bins, rep_fac, kfold_fac);
...
%Classification and kfolding for time domain features, Method Robert
[acc_AC23_time_robert_class_1_2] = permute_and_kfold(features_class_1_AC23_m1, ...
    features_class_2_AC23_m1, rep_fac, kfold_fac);
%Calculating features for method 1 (my "interesting" idea)
[features_class_1_AC23_m1, features_class_3_AC23_m1] = get_features_significantPoints(data_AC23_mrcp, ...
...
%Classification and kfolding for time domain features, Method Robert
[acc_AC23_time_robert_class_1_3] = permute_and_kfold(features_class_1_AC23_m1, ...
    features_class_3_AC23_m1, rep_fac, kfold_fac);
%Calculating features for method 1 (my "interesting" idea)
[features_class_2_AC23_m1, features_class_3_AC23_m1] = get_features_significantPoints(data_AC23_mrcp, ...
...
%Classification and kfolding for time domain features, Method Robert
[acc_AC23_time_robert_class_2_3] = permute_and_kfold(features_class_2_AC23_m1, ...
    features_class_3_AC23_m1, rep_fac, kfold_fac);
...
%Classification and kfolding for time domain features, Method Valeria
[acc_AC23_time_valeria_class_1_2] = permute_and_kfold(features_class_1_AC23_m2, ...
    features_class_2_AC23_m2, rep_fac, kfold_fac);
%Calculating features for method 2 (Valeria's Method)
[features_class_1_AC23_m2, features_class_3_AC23_m2] = get_features_significanceWindow(data_AC23_mrcp, ...
...
%Classification and kfolding for time domain features, Method Valeria
[acc_AC23_time_valeria_class_1_3] = permute_and_kfold(features_class_1_AC23_m2, ...
    features_class_3_AC23_m2, rep_fac, kfold_fac);
%Calculating features for method 2 (Valeria's Method)
[features_class_2_AC23_m2, features_class_3_AC23_m2] = get_features_significanceWindow(data_AC23_mrcp, ...
...
%Classification and kfolding for time domain features, Method Valeria
[acc_AC23_time_valeria_class_2_3] = permute_and_kfold(features_class_2_AC23_m2, ...
    features_class_3_AC23_m2, rep_fac, kfold_fac);
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_1_2] = permute_and_kfold(features_class_1_paper, ...
    features_class_2_paper, rep_fac, kfold_fac);
%Calculating features for method 3 (As in paper Method)
[features_class_1_paper, features_class_3_paper, ~] = get_features_paper(data_AC23_mrcp, ...
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_1_3] = permute_and_kfold(features_class_1_paper, ...
    features_class_3_paper, rep_fac, kfold_fac);
%Calculating features for method 3 (As in paper Method)
[features_class_2_paper, features_class_3_paper, ~] = get_features_paper(data_AC23_mrcp, ...
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_2_3] = permute_and_kfold(features_class_2_paper, ...
    features_class_3_paper, rep_fac, kfold_fac);
