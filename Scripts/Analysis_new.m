...
save('..\Data\Features Patient AC21', 'features_class_1_AC21_avrfreq', ...
    ...
    'features_class_1_paper', 'features_class_2_paper');
%%}
%%
%Patient AC22
%%{
...
%Calculating features for method 3 (As in paper Method)
[features_class_1_paper_12, features_class_2_paper_12, ~] = get_features_paper(data_AC23_mrcp, ...
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_1_2] = permute_and_kfold(features_class_1_paper_12, ...
    features_class_2_paper_12, rep_fac, kfold_fac);
%Calculating features for method 3 (As in paper Method)
[features_class_1_paper_13, features_class_3_paper_13, ~] = get_features_paper(data_AC23_mrcp, ...
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_1_3] = permute_and_kfold(features_class_1_paper_13, ...
    features_class_3_paper_13, rep_fac, kfold_fac);
%Calculating features for method 3 (As in paper Method)
[features_class_2_paper_23, features_class_3_paper_23, ~] = get_features_paper(data_AC23_mrcp, ...
...
%Classification and kfolding for frequency features from paper
[acc_AC23_time_paper_class_2_3] = permute_and_kfold(features_class_2_paper_23, ...
    features_class_3_paper_23, rep_fac, kfold_fac);
...
save('..\Data\Features Patient AC23', 'features_class_1_AC23_avrfreq', ...
    ...
    'features_class_1_paper_12', 'features_class_2_paper_12', ...
    'features_class_1_paper_13', 'features_class_3_paper_13', ...
    'features_class_2_paper_23', 'features_class_3_paper_23');
%%}