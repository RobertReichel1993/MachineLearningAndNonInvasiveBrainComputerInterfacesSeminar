...
%% ERDS maps
r1 = calcErdsMap(s, h, [-1, 0.05, 5], [5, 40], 'method', method, 'class', classes, 'ref', [0.25, 0.75], 'f_bandwidths', [2], 'f_steps', [1], 'sig', 'boxcox', 'lambda', 1, 'alpha', 0.05, 'heading', name, 'montage', [1 1 1 1], 'cue', 3, 'refmethod', refmethod);
plotErdsMap(r1);

%% Average/variance
r2 = calcAveVar(s, h, [-1, 0.05, 8], 'class', classes, 'heading', name, 'montage', [1 1 1 1], 'cue', 3);
plotAveVar(r2);

%% Combination of ERDS maps and average/variance
r3 = calcCombiMap(s, h, [-1, 0.05, 8], [5, 18, 40], 'method', method, 'class', classes, 'ref', [0.5, 1.5], 'f_bandwidths', [2, 4], 'f_steps', [1, 1], 'sig', 'boxcox', 'lambda', 1, 'alpha', 0.05, 'heading', name, 'montage', [1 1 1 1], 'cue', 3);
plotCombiMap(r3);