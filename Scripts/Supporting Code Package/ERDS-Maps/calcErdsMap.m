...
%
% This function calculates time-frequency (ERDS) maps by using either
% bandpower or FFT to estimate the power in specific frequency bands. Maps
% can be calculated for more than one channel at once.
%
% Usage:
...
% % If time starts before trial begin, shift all triggers
% if t(1) < 0
%     h.TRIG = h.TRIG - abs(t(1));
% end;
