...
%   $Revision: 1.1.6.21 $  $Date: 2012/04/20 19:15:41 $
...
if (hasIneqs || hasEqsAndBnds || hasMoreEqsThanVars || hasNoConstrs) && ...
   ...
   if algChoiceOptsConflict
       % Warn that active-set algorithm chosen as a result of conflicting options
       ...
       if AlgorithmUnsetByUser
           ...
           [linkTag,endLinkTag] = linkToAlgDefaultChangeCsh('qp_warnN1'); % links to context sensitive help       
           ...
           [linkTag,endLinkTag] = linkToAlgDefaultChangeCsh('qp_warnN2'); % links to context sensitive help       
           warning(message('optim:quadprog:TrrWillError',linkTag,endLinkTag));
       end
